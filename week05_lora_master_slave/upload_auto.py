...
Alternatif untuk menjalankan manual:
    ...
    pio run -d week05_lora_master_slave -e slave1  -t upload -t monitor
    pio run -d week05_lora_master_slave -e slave2  -t upload -t monitor
...
mungkin salah pasang.
    ...
    python3 week05_lora_master_slave/upload_auto.py
        -> upload ketiga board, port otomatis, lalu tanya mau monitor atau tidak

    python3 week05_lora_master_slave/upload_auto.py --monitor
    ...
    python3 week05_lora_master_slave/upload_auto.py --only master
        -> upload satu environment saja

    python3 week05_lora_master_slave/upload_auto.py --master /dev/ttyACM0 --slave1 /dev/ttyACM1 --slave2 /dev/ttyACM2
