#!/usr/bin/env python3
"""
LoRa ALOHA + ACK + Retry Monitor Dashboard
====================
Full-terminal live dashboard untuk monitoring komunikasi
LoRa Gateway <-> Node 1 & Node 2 (ACK + random backoff + retry otomatis saat timeout)
...
BANNER = """\
╔══════════════════════════════════════════════════════════════════════╗
║        LoRa ALOHA+RETRY Monitor — Evaluasi Praktikum        ║
...
╚══════════════════════════════════════════════════════════════════════╝
  ...
  diterima/OK/FAIL/RETRY, RSSI/SNR, deteksi anomali (GAP/FAIL beruntun),
...
def parse_args(port_aktif):
    ...
    p = argparse.ArgumentParser(
        description="LoRa ALOHA + ACK + Retry Monitor Dashboard -- tool evaluasi praktikum LoRa.",
