...
jauh lebih sulit, karena tiap jendela punya sumbu waktunya sendiri.
    ...
    python3 Modul01_lora_uart/monitor_serial.py
    python3 Modul01_lora_uart/monitor_serial.py --log sesi1.txt
    python3 Modul01_lora_uart/monitor_serial.py --port TX=/dev/ttyUSB0
    python3 Modul01_lora_uart/monitor_serial.py --durasi 60      # berhenti sendiri
...
lewat --port, mis. --port TX=/dev/ttyACM1 --port RX=/dev/ttyACM0.
