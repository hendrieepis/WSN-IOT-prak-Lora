...
# kedua sisi, jadi paket cacat memang naik sampai ke lapisan aplikasi alih-alih
# dibuang oleh radio. Monitor menandainya supaya terlihat, bukan tenggelam.
...
╚══════════════════════════════════════════════════════════════════════╝
  ...
  CATATAN:
    ...
    • Master di Raspberry Pi dijalankan terpisah:
      python3 Modul07_rpi_master_slave/src/master.py
