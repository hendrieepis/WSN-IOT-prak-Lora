/*
  ...
  Sisi slave Modul 07. Identik dengan slave Modul 05 -- itulah intinya: yang
  berganti platform hanya master (Arduino Uno -> Raspberry Pi + Python), dan
  firmware slave tidak perlu diubah satu baris pun. Kontrak payload yang sama
