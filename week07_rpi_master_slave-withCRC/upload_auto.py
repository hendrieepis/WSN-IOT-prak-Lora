...
Alternatif untuk menjalankan manual:
    pio run -d week07_rpi_master_slave-withCRC -e slave1 -t upload -t monitor
    pio run -d week07_rpi_master_slave-withCRC -e slave2 -t upload -t monitor
...
Raspberry Pi: python3 week07_rpi_master_slave-withCRC/src/master.py

    python3 week07_rpi_master_slave-withCRC/upload_auto.py
        -> upload kedua slave, port otomatis, lalu tanya mau monitor atau tidak

    python3 week07_rpi_master_slave-withCRC/upload_auto.py --monitor
    ...
    python3 week07_rpi_master_slave-withCRC/upload_auto.py --only slave1
        -> upload satu environment saja

    python3 week07_rpi_master_slave-withCRC/upload_auto.py --slave1 /dev/ttyACM0 --slave2 /dev/ttyACM1
