...
// Log serial lengkap dari Modul04_lora_ack/logserial.md. Hanya dicetak pada
...
// (lihat config.typ).
  ...
  *Board & Port*
  ...
  #tbl(
    ...
    [Log serial Modul 04: Board & Port],
    "tbl:m04-log-1",
  )
  ...
  *EXP-01 — Siklus ACK yang Sehat (45 detik)*
  ...
  #keluaran("[   1.812] RX | === LoRa ACK RECEIVER ===
...
[   2.012] RX |   Total : 1", pecah: true)
  ...
  #tbl(
    ...
    [Log serial Modul 04: EXP-01 — Siklus ACK yang Sehat (45 detik)],
    "tbl:m04-log-2",
  )
  ...
  *EXP-02 — Batas Waktu Bekerja*
  ...
  #keluaran("[  11.90] *  | >>> receiver kini diam
...
[  41.52] TX | [OK] ACK diterima! | OK: 4 | FAIL: 5", pecah: true)
  ...
  #tbl(
    ...
    [Log serial Modul 04: EXP-02 — Batas Waktu Bekerja],
    "tbl:m04-log-3",
  )
  ...
  *EXP-03 — Nomor Urut Harus Cocok*
  ...
  _03-a — penerima selalu membalas `ACK:99`_

  #keluaran("[  1.91] [RX] Balasan: ACK:99
[  1.97] [RX] WARN: bukan ACK yang diharapkan, tetap tunggu...
[  4.83] [FAIL] Tidak ada ACK! | OK: 0 | FAIL: 1", pecah: true)

  _03-b — penerima membalas `OKE`_

  #keluaran("[  1.90] [RX] Balasan: OKE
...
[  4.83] [FAIL] Tidak ada ACK! | OK: 0 | FAIL: 1", pecah: true)
  ...
  #tbl(
    table(
      ...
      inset: (x: 0.6em, y: 0.45em),
      stroke: 0.5pt + luma(170),
      table.header(th[Uji], th[Balasan tiba?], th[Diterima sebagai ACK?], th[`OK` bertambah?], th[Hasil akhir]),
    ...
    [Log serial Modul 04: 03-b — penerima membalas `OKE`],
    "tbl:m04-log-4",
  )
  ...
  _03-c — pasangan board lain berdekatan_
