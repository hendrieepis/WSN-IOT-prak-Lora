...
dengan penerima polling Modul 01 pada pekerjaan tiruan yang sama.
    ...
    python3 Modul02_lora_led_notif/monitor_serial.py
    python3 Modul02_lora_led_notif/monitor_serial.py --log sesi1.txt
    python3 Modul02_lora_led_notif/monitor_serial.py --port RX=/dev/ttyACM0
    python3 Modul02_lora_led_notif/monitor_serial.py --durasi 60      # berhenti sendiri
