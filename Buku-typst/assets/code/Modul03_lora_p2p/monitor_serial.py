...
percakapan sempat macet lalu dipulihkan sendiri oleh initiator.
    ...
    python3 Modul03_lora_p2p/monitor_serial.py
    python3 Modul03_lora_p2p/monitor_serial.py --log sesi1.txt
    python3 Modul03_lora_p2p/monitor_serial.py --port A=/dev/ttyACM0
    python3 Modul03_lora_p2p/monitor_serial.py --durasi 60      # berhenti sendiri
