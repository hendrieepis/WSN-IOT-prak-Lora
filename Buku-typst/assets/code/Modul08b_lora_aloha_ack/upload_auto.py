#!/usr/bin/env python3
"""Upload otomatis ke Modul 08B (ALOHA + ACK) — port serial dideteksi sendiri.
...
supaya tidak mungkin salah pasang.
    ...
    python3 Modul08b_lora_aloha_ack/upload_auto.py
        -> upload ketiga board, port otomatis, lalu tanya mau monitor atau tidak

    python3 Modul08b_lora_aloha_ack/upload_auto.py --monitor
    ...
    python3 Modul08b_lora_aloha_ack/upload_auto.py --only gateway
        -> upload satu environment saja

    python3 Modul08b_lora_aloha_ack/upload_auto.py --gateway /dev/ttyACM0 --node1 /dev/ttyACM1 --node2 /dev/ttyACM2
