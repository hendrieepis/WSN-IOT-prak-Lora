...
Alternatif untuk menjalankan manual:
    pio run -d Modul07_rpi_master_slave -e slave1 -t upload -t monitor
    pio run -d Modul07_rpi_master_slave -e slave2 -t upload -t monitor
...
Raspberry Pi: python3 Modul07_rpi_master_slave/src/master.py

    python3 Modul07_rpi_master_slave/upload_auto.py
        -> upload kedua slave, port otomatis, lalu tanya mau monitor atau tidak

    python3 Modul07_rpi_master_slave/upload_auto.py --monitor
    ...
    python3 Modul07_rpi_master_slave/upload_auto.py --only slave1
        -> upload satu environment saja

    python3 Modul07_rpi_master_slave/upload_auto.py --slave1 /dev/ttyACM0 --slave2 /dev/ttyACM1
