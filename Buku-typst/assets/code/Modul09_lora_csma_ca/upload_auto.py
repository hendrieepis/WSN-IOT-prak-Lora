#!/usr/bin/env python3
"""Upload otomatis ke Modul 08 (CSMA/CA) — port serial dideteksi sendiri.
...
supaya tidak mungkin salah pasang.
    ...
    python3 Modul09_lora_csma_ca/upload_auto.py --monitor
    ...
    python3 Modul09_lora_csma_ca/upload_auto.py --only gateway
        -> upload satu environment saja

    python3 Modul09_lora_csma_ca/upload_auto.py --gateway /dev/ttyACM0 --node1 /dev/ttyACM1 --node2 /dev/ttyACM2
