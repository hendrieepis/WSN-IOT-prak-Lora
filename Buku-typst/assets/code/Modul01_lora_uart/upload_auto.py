...
Alternatif untuk menjalankan manual:
    ...
    pio run -d Modul01_lora_uart -e receiver -t upload -t monitor
...
deteksi ulang), supaya tidak mungkin salah pasang.
    ...
    python3 Modul01_lora_uart/upload_auto.py
        -> upload kedua board, port otomatis, lalu tanya mau monitor atau tidak

    python3 Modul01_lora_uart/upload_auto.py --monitor
    ...
    python3 Modul01_lora_uart/upload_auto.py --only sender
        -> upload satu environment saja

    python3 Modul01_lora_uart/upload_auto.py --sender /dev/ttyACM0 --receiver /dev/ttyACM1
