...
deteksi ulang), supaya tidak mungkin salah pasang.
    ...
    python3 Modul04_lora_ack/upload_auto.py
        -> upload kedua board, port otomatis, lalu tanya mau monitor atau tidak

    python3 Modul04_lora_ack/upload_auto.py --monitor
    ...
    python3 Modul04_lora_ack/upload_auto.py --only sender
        -> upload satu environment saja

    python3 Modul04_lora_ack/upload_auto.py --sender /dev/ttyACM0 --receiver /dev/ttyACM1
