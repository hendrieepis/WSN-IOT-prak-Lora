...
deteksi ulang), supaya tidak mungkin salah pasang.
    ...
    python3 week02_lora_led_notif/upload_auto.py
        -> upload kedua board, port otomatis, lalu tanya mau monitor atau tidak

    python3 week02_lora_led_notif/upload_auto.py --monitor
    ...
    python3 week02_lora_led_notif/upload_auto.py --only sender
        -> upload satu environment saja

    python3 week02_lora_led_notif/upload_auto.py --sender /dev/ttyUSB0 --receiver /dev/ttyACM1
