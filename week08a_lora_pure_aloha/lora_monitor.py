#!/usr/bin/env python3
"""
LoRa Pure ALOHA Monitor Dashboard
===========
Full-terminal live dashboard untuk monitoring komunikasi
LoRa Gateway <-> Node 1 & Node 2 (kirim bebas tanpa carrier-sense, tanpa ACK, tanpa retry)
...
BANNER = """\
╔══════════════════════════════════════════════════════════════════════╗
║        LoRa PURE ALOHA  Monitor — Evaluasi Praktikum        ║
...
╚══════════════════════════════════════════════════════════════════════╝
  ...
  diterima/OK/FAIL, RSSI/SNR, deteksi anomali (GAP/FAIL beruntun),
...
def parse_args(port_aktif):
    ...
    p = argparse.ArgumentParser(
        description="LoRa Pure ALOHA Monitor Dashboard -- tool evaluasi praktikum LoRa.",
