...
mencatat gagal karena ACK-nya yang hilang.
    ...
    python3 week04_lora_ack/monitor_serial.py --log sesi1.txt
    python3 week04_lora_ack/monitor_serial.py --port RX=/dev/ttyACM0
    python3 week04_lora_ack/monitor_serial.py --durasi 60      # berhenti sendiri
...
DEFAULT_PORTS = [
    ("TX", "/dev/ttyUSB0", "\033[33m"),   # kuning — pengirim
